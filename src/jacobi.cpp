...
Rcpp::ComplexMatrix JTheta1(Rcpp::ComplexMatrix z0, Rcomplex dalet) {
  ...
  for(int j = 0; j < n; j++) {
    ...
    for(int i = 0; i < m; i++) {
      zj(i) = toCplx(jtheta1_cpp(fromCplx(z(i,j)), tau));
    }
    z(Rcpp::_, j) = zj;
  }
  return z;
...
Rcpp::ComplexMatrix JTheta2(Rcpp::ComplexMatrix z0, Rcomplex dalet) {
  ...
  for(int j = 0; j < n; j++) {
    Rcpp::ComplexVector zj(m);
    for(int i = 0; i < m; i++) {
      zj(i) = toCplx(jtheta2_cpp(fromCplx(z(i,j)), tau));
    }
    z(Rcpp::_, j) = zj;
  }
  return z;
...
Rcpp::ComplexMatrix JTheta3(Rcpp::ComplexMatrix z0, Rcomplex dalet) {
  ...
  for(int j = 0; j < n; j++) {
    Rcpp::ComplexVector zj(m);
    for(int i = 0; i < m; i++) {
      zj(i) = toCplx(jtheta3_cpp(fromCplx(z(i,j)), tau));
    }
    z(Rcpp::_, j) = zj;
  }
  return z;
...
Rcpp::ComplexMatrix JTheta4(Rcpp::ComplexMatrix z0, Rcomplex dalet) {
  ...
  for(int j = 0; j < n; j++) {
    Rcpp::ComplexVector zj(m);
    for(int i = 0; i < m; i++) {
      zj(i) = toCplx(jtheta4_cpp(fromCplx(z(i,j)), tau));
    }
    z(Rcpp::_, j) = zj;
  }
  return z;
...
Rcpp::ComplexMatrix LJTheta1(Rcpp::ComplexMatrix z0, Rcomplex dalet) {
  ...
  for(int j = 0; j < n; j++) {
    Rcpp::ComplexVector zj(m);
    for(int i = 0; i < m; i++) {
      zj(i) = toCplx(ljtheta1_cpp(fromCplx(z(i,j)), tau));
    }
    z(Rcpp::_, j) = zj;
  }
  return z;
...
Rcpp::ComplexMatrix LJTheta2(Rcpp::ComplexMatrix z0, Rcomplex dalet) {
  ...
  for(int j = 0; j < n; j++) {
    Rcpp::ComplexVector zj(m);
    for(int i = 0; i < m; i++) {
      zj(i) = toCplx(ljtheta2_cpp(fromCplx(z(i,j)), tau));
    }
    z(Rcpp::_, j) = zj;
  }
  return z;
...
Rcpp::ComplexMatrix LJTheta3(Rcpp::ComplexMatrix z0, Rcomplex dalet) {
  ...
  for(int j = 0; j < n; j++) {
    Rcpp::ComplexVector zj(m);
    for(int i = 0; i < m; i++) {
      zj(i) = toCplx(ljtheta3_cpp(fromCplx(z(i,j)), tau));
    }
    z(Rcpp::_, j) = zj;
  }
  return z;
